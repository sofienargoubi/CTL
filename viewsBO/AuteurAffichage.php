...
<div class="page-wrapper">
    ...
    <div class="page-container">
                        ...
                        <div class="table-responsive table-responsive-data2">
                            <table class="table table-data2">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td class="desc"><?php echo $row['prenom']; ?></td>
                                    ...
                                    <td>
                                        <div class="table-data-feature">
                                            ...
                                            <a href="supprimerAuteur.php?id=<?php echo $row['id']; ?>">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="login-form">
                                            <form action="modifierAuteur.php" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit=" return VerifForm()">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">Taper Prenom </label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="prenom" name="prenom" placeholder="Prenom.." class="form-control" value="<?php echo $row['prenom']; ?>">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    <p>Copyright © 2019 Tech Army. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<div id="m" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="login-form">
                    <form action="ajoutAuteur.php" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit=" return VerifForm()">
