                    ...
                    <div class="container-fluid">
                        <div class="row">
                                            ...
                                            $(document).ready(function(){
                                                $.ajax({
                                                    ...
                                                    success: function(dataa) {
                                                        // console.log(data);
                                                        data3 = JSON.parse(dataa);
                                                        // console.log(data2);
                                                        var player = [];
                                                        var score = [];

                                                        for(var i in data3) {
                                                            player.push( data3[i].Createur);
                                                            score.push(data3[i].Number);
                                                        }
                                                        console.log(player);
                                                        var chartdata = {
                                                            labels: player,
                            ...
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">nombre de vente par editeur</h3>

                                        <div id="chart-container">
                                            <canvas id="editeur"></canvas>
                                        </div>
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(data) {
                                                        ...
                                                        var chartdata = {
                                                            ...
                                                            datasets : [
                                                                {
                                                                    label: 'Nombre de vente par editeur ',
                                                                    backgroundColor: '#a94442',
                                                                    borderColor: '#a94442',
                                                                    hoverBackgroundColor: '#d15855',
                                                                    hoverBorderColor: '#d15855',
                            ...
                            <div class="col-lg-6">
                                <div class="au-card m-b-30">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 m-b-40">Nobre de vente par auteur</h3>

                                        <div id="chart-container">
                                            <canvas id="auteur"></canvas>
                                        </div>
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function(data) {
                                                        ...
                                                        var chartdata = {
                                                            ...
                                                            datasets : [
                                                                {
                                                                    label: 'Nombre de vente par auteur ',
                                                                    backgroundColor: '#a94442',
                                                                    borderColor: '#a94442',
                                                                    hoverBackgroundColor: '#d15855',
                                                                    hoverBorderColor: '#d15855',
