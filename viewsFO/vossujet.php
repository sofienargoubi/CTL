...
?>     
                            ...
                            <div class="shop-tab-list">
                                <div class="shop-tab-pill pull-left">
                                    <div class="layer-5">
                                        <ul>
                                            <li>
                                                <form class="title-5">
                                                    <input type="reche" type="text" placeholder="Enter your tags" onkeyup="showCustomer(this.value)">
                                ...
                                <div class="shop-tab-pill pull-right">
                                    <ul>
                                            <li class="product-size-deatils2">
                                                <div class="show-label">
                                                    <label><i class="fa fa-sort-amount-asc"></i>Sort by : </label>
                                                        <select name='tri' onchange="sort(this.value)">
                                         ...
                                         <?php
                                        $b=$sujetF->nbsujets($_SESSION["Nom"]);
     foreach($b as $row2)
        { $n=ceil($row2["n"]/6);}
    if($n>1){
    ...
    for($i=1;$i<=$n;$i++){
                                    ?>
                                    <li class="shop-pagination"><a href="vossujet.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                                <?php }} ?>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="menu1">
                                    <div class="row" id="det">
                                        ...
                                        if(isset($_GET['page']))
                                        {$nbs=($_GET['page']*6)-6;
                                            $list=$sujetF->recupererSujets($nbs,$_SESSION["Nom"]);}
                                        else
                                            $list=$sujetF->recupererSujets(1,$_SESSION["Nom"]);
                                        ?>
...
<?php require "footer.php"?>
        ...
        function sort(id)
 {
  ...
  xhttp.open("GET", "recheVos.php?q="+str, true);
  xhttp.send();
}
